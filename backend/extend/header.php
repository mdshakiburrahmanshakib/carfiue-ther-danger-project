        ...
        <div class="app-sidebar">
            ...
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li class="<?= ($extention == "home.php") ? 'active-page' : '' ?>">
                        <a href="../home/home.php" class="active"><i class="material-icons-two-tone">dashboard</i>Dashboard</a>
                    </li>
                    <li class="<?= ($extention == "settings.php") ? 'active-page' : '' ?>">
                        <a href="../settings/settings.php" class="active"><i class="material-icons-two-tone">settings</i>Settings</a>
                    </li>
                    <li class="<?= ($extention == "services.php") ? 'active-page' : '' ?>">
                        <a href="../services/services.php"><i class="material-icons-two-tone">medical_services</i>Services</a>
                    </li>
                    <li class="<?= ($extention == "portfolios.php") ? 'active-page' : '' ?>">
                        <a href="../portfolio/portfolios.php"><i class="material-icons-two-tone">design_services</i>Portfolios</a>
                    </li>
                    <li class="<?= ($extention == "testimonials.php") ? 'active-page' : '' ?>">
                        <a href="../testsmonial/testimonials.php"><i class="material-icons-two-tone">reviews</i>Testimonials</a>
                    </li>
                    <li class="<?= ($extention == "about.php") ? 'active-page' : '' ?>">
                        <a href="../about/about.php"><i class="material-icons-two-tone">info</i>About</a>
                    </li>
                    <li class="<?= ($extention == "contacts.php") ? 'active-page' : '' ?>">
                        <a href="../contact/contacts.php"><i class="material-icons-two-tone">contacts</i>Contacts</a>
                    </li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="d-flex">
                            <ul class="navbar-nav">
                                <li class="nav-item hidden-on-mobile">
                                    <a class="nav-link btn-sm btn btn-dark text-white" href="../logout/logout.php">
                                ...
                                <li class="nav-item hidden-on-mobile">
                                    <a class="nav-link language-dropdown-toggle" href="#" id="languageDropDown" data-bs-toggle="dropdown"><img src="../../public/assets/images/flags/us.png" alt=""></a>
                                        <ul class="dropdown-menu dropdown-menu-end language-dropdown" aria-labelledby="languageDropDown">
                                            <li><a class="dropdown-item" href="#"><img src="../../public/assets/images/flags/germany.png" alt="">German</a></li>
                                            <li><a class="dropdown-item" href="#"><img src="../../public/assets/images/flags/italy.png" alt="">Italian</a></li>
                                            <li><a class="dropdown-item" href="#"><img src="../../public/assets/images/flags/china.png" alt="">Chinese</a></li>
                                        </ul>
                                </li>
                                <li class="nav-item hidden-on-mobile">
                                                ...
                                                <div class="notifications-dropdown-item">
                                                    <div class="notifications-dropdown-item-image">
                                                        <span class="notifications-badge">
                                                            <img src="../../public/assets/images/avatars/avatar.png" alt="">
                                                        </span>
                                                    </div>
                                                    <div class="notifications-dropdown-item-text">
