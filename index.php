...
// Portfolio Querry End


// Testimonial Querry 
$test_query = "SELECT * FROM testimonials";
$testimonials = mysqli_query($db,$test_query);
// Testimonial Querry End


// Contact Querry 
$contact_query = "SELECT * FROM contacts";
$contacts = mysqli_query($db,$contact_query);
$connect = mysqli_fetch_assoc($contacts);
// Contact Querry End
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-7 col-lg-6">
                            <div class="banner-content">
                                <h6 class="wow fadeInUp" data-wow-delay="0.2s">HELLO!</h6>
                                 <?php if(isset($_SESSION['author_id'])): ?>
                                <h2 class="wow fadeInUp" data-wow-delay="0.4s">I am  <?= $_SESSION['author_name']?></h2>
                                <p class="wow fadeInUp" data-wow-delay="0.6s">I'm <?= $_SESSION['author_name']?>, professional web developer with long time experience in this field​.</p>
                                <?php else: ?>
                        ...
                        <div class="col-xl-5 col-lg-6 d-none d-lg-block">
                            <div class="banner-img text-right">
                                <?php if(isset($_SESSION['author_id'])): ?> 
                                    <img src="./public/uploads/profile/<?= $user['image'] ?>" alt="" style="width:600px; height: 820px;">
                                <?php else: ?>  
                        ...
                        <div class="col-lg-4 col-md-6 pitem">
                            <div class="speaker-box">
								<div class="speaker-thumb">
									<img style="height: 600px; object-fit:cover;" src="./public/uploads/portfolio/<?= $portfolio['image'] ?>" alt="img">
								</div>
								<div class="speaker-overlay">
									<span>
                                        <?= $portfolio['subtitle'] ?>
                                    </span>
									<h4><a href="./backend/portfolio/single.php">
                                        <?= $portfolio['title'] ?>
                                    </a></h4>
									<a href="./backend/portfolio/single_port.php?single_id=<?= $portfolio['id'] ?>" class="arrow-btn">More information <span></span></a>
								</div>
							</div>
                        </div>
                        <?php endforeach; ?>
                            ...
                            <?php foreach($testimonials as $testimonial): ?>
                                <div class="single-testimonial text-center">
                                    <div class="testi-avatar">
                                        <img style="height: 85px; width:85px; border-radius:50%" src="./public/uploads/testimonial/<?= $testimonial['image'] ?>" alt="img" >
                                    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            ...
                            <div class="contact-content">
                                ...
                                <h5>OFFICE IN <span><?= $connect['city'] ?></span></h5>
                                <div class="contact-list">
                                    <ul>
                                        <li><i class="fas fa-map-marker"></i><span>Address :</span><?= $connect['address'] ?></li>
                                        <li><i class="fas fa-headphones"></i><span>Phone :</span><?= $connect['phone'] ?></li>
                                        <li><i class="fas fa-globe-asia"></i><span>e-mail :</span><?= $connect['email'] ?></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
